...
import "./MeowFactory.sol";
import "./IMeowMarketplace.sol";

contract MeowMarketPlace is Ownable, IMeowMarketPlace {
    MeowFactory internal _kittyContract;
    ...
    function setKittyContract(address _kittyContractAddress) public onlyOwner {
        _kittyContract = MeowFactory(_kittyContractAddress);
    }
